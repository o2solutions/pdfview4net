...
Namespace FormDesigner.VB
    ...
    ''' </summary>
    Partial Public Class RadioButtonPropertiesForm
        Inherits Window
        ...
        Public Sub New()
            ...
            DataContext = Me
        End Sub
        Private _radioButtonField As PDFRadioButtonListField
        ...
        ''' </value>
        Public Property RadioButtonField() As PDFRadioButtonListField
            Get
                Return _radioButtonField
            End Get
            Set(ByVal value As PDFRadioButtonListField)
                _radioButtonField = value
                FirePropertyChanged("RadioButtonField")
            End Set
        End Property

        Private _radioButtonWidget As PDFRadioButtonItem
        ...
        Public Property RadioButtonWidget() As PDFRadioButtonItem
            ...
            End Get
            Set(ByVal value As PDFRadioButtonItem)
                _radioButtonWidget = value
                FirePropertyChanged("RadioButtonWidget")
            End Set
        End Property
        ...
        Public Property IsLocked() As Boolean
            Get
                Return RadioButtonWidget IsNot Nothing AndAlso (RadioButtonWidget.Flags And PDFAnnotationFlags.Locked) = PDFAnnotationFlags.Locked
            End Get
            Set(ByVal value As Boolean)
                If RadioButtonWidget IsNot Nothing Then
                    If value Then
                        RadioButtonWidget.Flags = RadioButtonWidget.Flags Or PDFAnnotationFlags.Locked
                    Else
                        RadioButtonWidget.Flags = RadioButtonWidget.Flags And Not PDFAnnotationFlags.Locked
                    End If
